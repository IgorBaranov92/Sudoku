...
struct Options: Codable {
    ...
    private(set) var optionsOnDescription = ["В каждой игре докускается совершить три ошибки","Выделять неправильно поставленную цифру","Выделяет строку, столбец, квадрат 3х3 для текущей клетки","smarthints","Скрывать использованные цифры(расставлены все единицы или двойки)"]
